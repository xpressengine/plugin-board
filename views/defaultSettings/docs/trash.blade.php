    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="btn-group pull-left mg-bottom mg-right-sm __xe_function_buttons">
                <button type="button" class="btn btn-default __xe_button" data-mode="restore">
                    <i class="fa fa-refresh"></i>복원</a>
                </button>
                ...
                <form class="__xe_search_form" method="get">
                    <div class="input-group mg-bottom">
                        ...
                        <div class="input-group-btn">
                            ...
                            <a href="{{$urlHandler->managerUrl('docs.trash')}}" class="btn btn-default">취소</a>
                        </div>
                    </div>
                </form>
            </div>
