<div class="board_read">
    <div class="read_header">
        ...
        <div class="more_info">
            <a href="#" class="mb_autohr __xe_member" data-id="" data-text="{{ $writer }}">{{ $writer }}</a>
            <span class="mb_time __xe_short_date" title="{{$currentDate}}" data-timestamp="{{strtotime($currentDate)}}"><i class="xi-time"></i> {{$currentDate}}</span>
