{{ Frontend::js('plugins/board/assets/js/board.js')->appendTo('body')->load() }}
{{ Frontend::js('plugins/board/assets/js/userSkin.js')->appendTo('body')->load() }}
...
{{ Frontend::css('plugins/board/assets/css/tomorrow-night-eighties.css')->load() }}
