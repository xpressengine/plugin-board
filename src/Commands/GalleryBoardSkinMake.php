...
/**
 * Class GallerySkinMake
 *
 * Gallery Board Skin Make Command
 *
 * @package Xpressengine\Plugins\Board\Commands
 */
final class GalleryBoardSkinMake extends BoardSkinMake
{
    use RegisterArtisan;
     ...
     * @var string
     */
    protected $signature = 'make:gallery_board_skin
     ...
     * @var string
     */
    protected $description = 'Create a new gallery board skin';
    ...
    {
        return __DIR__.'/stubs/gallery_board_skin';
    }
    ...
    {
        return $this->option('title') ?: studly_case($this->getComponentName()) . ' Gallery Board skin';
    }
}