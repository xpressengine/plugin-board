...
final class CommonSkinMake extends \App\Console\Commands\SkinMake
{
    use RegisterArtisan;
     ...
     * @var string
     */
    protected $signature = 'make:board-common-article-list-widget-skin
     ...
     * @var string
     */
    protected $description = "Create a new board common widget skin of XpressEngine";
