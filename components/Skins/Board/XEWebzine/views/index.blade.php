{{ XeFrontend::css('plugins/board/assets/css/xe-board-webzine.css')->load() }}
    ...
    <div class="xf-board-form-box">
        <div class="xf-board-search-box">
            <div class="xf-search-input-box">
                <input class="xf-search-input" type="text" name="title_pure_content"
                       value="{{ Request::get('title_pure_content') }}" placeholder="검색어를 입력하세요">
            </div>
...
<ul class="xf-board-list xf-list">
                ...
                <div class="xf-thumbnail-box">
                    <a href="{{$urlHandler->getShow($item, Request::all())}}" class="xf-board-item__link xf-a">
                        <div class="xf-thumbnail-img"
                             @if ($item->board_thumbnail_path) style="background-image:url({{ $item->board_thumbnail_path }});" @endif></div>
                        <div class="xf-thumbnail-notice">
                            <span class="xf-notice__text">공지</span>
                        </div>
                    </a>
                </div>
                <div class="xf-detail-box">
                    <a href="{{$urlHandler->getShow($item, Request::all())}}" class="xf-board-item__link xf-a">
                        <div class="xf-post-contents xf-mb16">
                            ...
                            @endif
                            <div class="xf-post-title xf-ellipsis2 xf-mb08">
