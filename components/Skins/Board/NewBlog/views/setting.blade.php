                ...
                <div class="panel-collapse">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="visibleIndexBlogProfileImage" value="on" @if (array_get($config, 'visibleIndexBlogProfileImage', 'on') === 'on') checked @endif>프로필 사진
                                </label>
                                <label>
                                    <input type="checkbox" name="visibleIndexBlogDescription" value="on" @if (array_get($config, 'visibleIndexBlogDescription', 'on') === 'on') checked @endif>본문 미리보기
                                </label>
                            </div>
                        </div>
