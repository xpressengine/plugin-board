                        ...
                        <table class="table">
                            ...
                            @foreach($documents as $document)
                                <tr>
                                    ...
                                    <td><span class="label label-green">{{ xe_trans($displayName[$document->display]) }}</span></td>
                                    <td><span class="label label-grey">{{ xe_trans($approveName[$document->approved]) }}</span></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
