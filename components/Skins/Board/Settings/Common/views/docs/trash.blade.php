                        ...
                        <table class="table">
                            ...
                            @foreach($documents as $document)
                                <tr>
                                    ...
                                    <td><a href="/{{ $urls[$document->instance_id] }}/show/{{ $document->id }}" target="_blank"><strong>[{{ $titles[$document->instance_id] }}]</strong> {{ $document->title }}<i class="xi-new"></i><i class="xi-external-link"></i></a></td>
