...
<form method="post" id="board_form" class="xf-board-writing-form __board_form"
                ...
                @if($config->get('secretPost') === true)
                    <li class="xf-check-item">
                        <input type="checkbox" class="xf-check-item__input"
                               ...
                               value="{{ $item::DISPLAY_SECRET }}"
                               @if($item->display == $item::DISPLAY_SECRET) checked="checked" @endif>
