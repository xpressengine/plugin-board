...
namespace Xpressengine\Plugins\Board\Components\Skins\Board\Basic;
 ...
 * @link        https://xpressengine.io
 */
class BasicSkin extends GenericBoardSkin
{
    protected static $path = 'board/components/Skins/Board/Basic';
    ...
    public static function interceptDynamicField()
    {
        intercept(
            ...
            'board@basicSkin::createDynamicField',
    ...
    public function render()
    {
        ...
        /**
         * If view file is not 'index.blade.php' then change view path to BasicSkin's path.
         * BasicSkin extends by other Skins. Extended Skin can make just 'index.blade.php'
         * and other blade files will use to BasicSkin's blade files.
         */
//        if ($this->view != 'index') {
//            static::$path = self::$path;
//        }
        /**
         * If view file is not exists to extended skin component then change view path to BasicSkin's path.
         * BasicSkin extends by other Skins. Extended Skin can make own blade files.
         * If not make blade file then use to BasicSkin's blade files.
         */
         ...
         * then use BasicSkin's '_frame.blade.php' for layout.
...
//            $instanceId = $arr[1];
//
//            return View::make(sprintf('%s/views/setting', BasicSkin::$path), [
