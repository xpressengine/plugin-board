                ...
                <div class="cont_area">
                    ...
                    <div class="more_info">
                        ...
                        @if (in_array('favorite', $skinConfig['listColumns']) == true)
                            @if (Auth::check() === true)
                                <a href="#" data-url="{{$urlHandler->get('favorite', ['id' => $item->id])}}" class="favorite @if($item !== null) on @endif __xe-bd-favorite"  title="{{xe_trans('board::favorite')}}"><i class="xi-star"></i><span class="xe-sr-only">{{xe_trans('board::favorite')}}</span></a>
                            @endif
                        @endif
