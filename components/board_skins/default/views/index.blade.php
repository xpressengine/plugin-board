...
{{ XeFrontend::js('plugins/board/components/board_skins/default/assets/js/build/board.js')->appendTo('body')->load() }}
            ...
            @foreach($notices as $item)
                ...
                <tr class="no_article">
                    ...
                    <td colspan="{{ count($skinConfig['listColumns']) + 2 }}">
                        <img src="/plugins/board/components/board_skins/default/assets/img/img_pen.jpg" alt="">
